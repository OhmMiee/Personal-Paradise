...
def MAIN_herbs(herbs,texture,grade): #สูตรคำนวณราคาสมุนไพร
    while True:
        try:
...
while True:
    while True:
        while True:
            ...
            GRADE(h)
            if h in {11}:
                print("\nท่านต้องการ Ganja แบบไหน 1 แบบสด หรือ 2 แบบอบแห้ง")
            #ลูป t ถ้ากรอกผิด
                while True:
                    try:
                        t = int(input())
            ...
            #ลูป g ถ้ากรอกผิด
            while g not in {"P","A","B","C","D","p","a","b","c","d"}:
    ...
    #คิดราคา
    if sum(price) >= 666:
        amount = math.ceil(sum(price)) - 100
        print("รวมเป็นเงินทั้งสิ้น",math.ceil(sum(price)),"บาท ท่านได้รับส่วนลด 100 บาท เหลือทั้งหมด",amount,"บาท")
    else:
    ...
    while True:
        try:
            ...
            if pay > amount or pay == amount:
                break
            if count != 0 and pay == 0:
                break
            print("จำนวนเงินของท่านไม่พอ กรุณาใส่จำนวนเงินใหม่")
            print("หากต้องการยกเลิกรายการทั้งหมด ให้พิมพ์ 0")
        except ValueError:
            print("จำนวนเงินของท่านไม่พอ กรุณาใส่จำนวนเงินใหม่")
            print("หากต้องการยกเลิกรายการทั้งหมด ให้พิมพ์ 0")
    if pay == 0:
        ...
        del quality[:]
        del kilo[:]
        print("รายการทั้งหมดถูกยกเลิกแล้ว กรุณาเลือกสินค้าใหม่")    
    elif pay > amount:
        break
    elif pay == amount:
        break
...
if pay > amount:
    change = pay - amount
    bank_1000 = change // 1000
    if bank_1000 > 0:
        b_1000 = "แบงค์พัน = " +str(bank_1000)+" ใบ"
        print("(",b_1000,")")
    bank_100 = (change % 1000) // 100
    if bank_100 > 0:
        b_100 = "แบงค์ร้อย = " +str(bank_100)+" ใบ"
        print("(",b_100,")")
    bank_20 = (change % 100) // 20
    if bank_20 > 0:
        b_20 = "แบงค์ยี่สิบ = " +str(bank_20)+" ใบ"
        print("(",b_20,")")
        
    coin_10 = (change % 100) // 10
    if coin_10 > 0:
        c_10 = "เหรียญสิบ = " +str(coin_10)+" เหรียญ"
        print("(",c_10,")")
    coin_5 = (change % 10) // 5
    if coin_5 > 0:
        c_5 = "เหรียญห้า = " +str(coin_5)+" เหรียญ"
        print("(",c_5,")")
    ...
    z = coin_1 - coin_5 * 5
    if z > 0:
        c_1 = "เหรียญบาท = " +str(z)+" เหรียญ"
        print("(",c_1,")")
    print("ชำระเงินเสร็จสิ้น เงินทอน =",change,"บาท")
    print("ขอบคุณที่ใช้บริการร้านสมุนไพรของเรา")
else:
    print("ชำระเงินเสร็จสิ้น")
    print("ขอบคุณที่ใช้บริการร้านสมุนไพรของเรา")
